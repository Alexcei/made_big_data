...
//}
//
//class CustomLinearRegression(override val uid: String) extends Estimator[CustomLinearRegressionModel]
//  with CustomLinearRegressionParams with DefaultParamsWritable {
//
//    def this() = this(Identifiable.randomUID("linearRegression"))
//
//    override def fit(dataset: Dataset[_]): CustomLinearRegressionModel = {
...
//}
//
//class CustomLinearRegressionModel(override val uid: String, val coefficients: Vector) extends Model[CustomLinearRegressionModel]
//  with CustomLinearRegressionParams {
//
//    private[regression] def this(coefficients: Vector) = this(Identifiable.randomUID("linearRegressionModel"), coefficients)
//
//    override def transformSchema(schema: StructType): StructType = {
